...
export function Sidebar({ currentNews, allNews }) {
    ...
    return (
        ...
        <Card>
            ...
            <h3 className="text-lg font-semibold mb-4">{direction === 'ltr' ? 'More in' : 'المزيد من '} {currentNews.category}</h3>
        ...
        <Card>
            <CardContent className="p-6">
            <h3 className="text-lg font-semibold mb-4">{direction === 'ltr' ? 'Latest News' : 'اخر الاخبار '}</h3>
            <div className="space-y-4">
                {allNews
